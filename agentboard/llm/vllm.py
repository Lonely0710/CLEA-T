...
class VLLM:
    ...
    def make_prompt(self, system_message, prompt):
        ...
        if os.environ.get("Finetuned") == "1":
            print("Alert!!!! You are using the fixed prompt for finetuned models")
            full_prompt = self.make_sft_prompt(system_message, prompt)
        else:
            print("Alert!!!! The environemnt variable is set to zero. So adopt the original agentboard logic.")
